package com.aks.product.handler;
...
import com.aks.product.contstant.ProductConstants;
import com.aks.product.enums.EventType;
import com.aks.product.model.ExchangeEvent;
import com.aks.product.producer.ExchangeEventProducer;
...
public class CustomHandlerInterceptor implements WebFilter {
	...
	public Mono<Void> filter(ServerWebExchange exchange, WebFilterChain chain) {
		...
		exchangeEvent.setEventType(EventType.PRODUCT_MS_REQUEST);
